...
function ConfidenceMeter({ value, compact = false }) {
  ...
  const w     = compact ? 80 : 130;
  return (
    <div style={{ display: "flex", alignItems: "center", gap: compact ? 6 : 10 }}>
      <div style={{ width: w, height: compact ? 5 : 6, background: "#1e2d45", borderRadius: 4, overflow: "hidden" }}>
        <div style={{
          width: `${pct}%`, height: "100%", background: color, borderRadius: 4,
          transition: "width 0.8s ease", boxShadow: compact ? "none" : `0 0 8px ${color}88`,
        }} />
      </div>
      <span style={{ color, fontWeight: 700, fontSize: compact ? 11 : 13, minWidth: 36 }}>{pct}%</span>
    </div>
  );
}
          ...
          <div style={{ marginTop: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14, flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <div style={{ width: 130 }}><ConfidenceMeter value={result.confidence} /></div>
              </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {!msg.loading && !msg.error && (
            <div style={{ marginTop: 8, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
              <ConfidenceMeter value={msg.confidence} compact />
